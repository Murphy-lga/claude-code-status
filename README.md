...
```json
{
  "hooks": {
    ...
    "PostToolUseFailure": [{ "matcher": "", "hooks": [{ "type": "command", "command": "node \"C:\\Users\\你的用户名\\.claude\\scripts\\write-status.js\" error", "async": true }] }],
    ...
    "StopFailure":       [{ "matcher": "", "hooks": [{ "type": "command", "command": "node \"C:\\Users\\你的用户名\\.claude\\scripts\\write-status.js\" error",    "async": true }] }],
...
<table>
  <tr>
    <td align="center"><img width="240" alt="WeChat" src="https://github.com/user-attachments/assets/819422ae-0fcf-428d-8557-f10966feec17" /><br/>微信</td>
    <td align="center"><img width="240" alt="Alipay" src="https://github.com/user-attachments/assets/0ab51315-4188-4c22-b730-c366eff88233" /><br/>支付宝</td>
  </tr>
</table>
